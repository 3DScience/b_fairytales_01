...
public class ScenceController_tvr : MonoBehaviour {
	...
	void Start () {
        ...
        //Move camera
        camera.GetComponent<MovingCam_tvr>().StartScence();
    ...
    void StartScenceLight()
    {
        if (light.intensity < 5.7)
            ...
            book.GetComponent<BookController_tvr>().open();
    ...
    public void StartStoryTellScence()
    {
        ...
        camera.GetComponent<MovingCam_tvr>().StoryTellScence();
    }
}
